 ...
 *
 * STATUS:
 * ✅ 4 WORKING TESTS - Basic reactor & drive operations
 * ⏭️ 6 SKIPPED TESTS - TodoList operations (waiting for subgraph to load)
 *
 * The TodoList document model and subgraph have been successfully copied from
 * the official todo-demo repository. However, to test TodoList operations, we need:
 * 1. Reactor running with TodoList subgraph loaded
