...
describe('Node Operations', () => {
    ...
    it('should handle addFile operation', () => {
        ...
        expect(updatedDocument.operations[0].type).toBe('ADD_FILE');
    ...
    it('should handle addFolder operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(1);
        expect(updatedDocument.operations[0].type).toBe('ADD_FOLDER');
        expect(updatedDocument.operations[0].input).toStrictEqual(input);
        expect(updatedDocument.operations[0].index).toEqual(0);
    });
    ...
    it('should handle deleteNode operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(2);
        expect(updatedDocument.operations[1].type).toBe('DELETE_NODE');
        expect(updatedDocument.operations[1].input).toStrictEqual(input);
        expect(updatedDocument.operations[1].index).toEqual(1);
    });
    ...
    it('should handle updateFile operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(2);
        expect(updatedDocument.operations[1].type).toBe('UPDATE_FILE');
        expect(updatedDocument.operations[1].input).toStrictEqual(input);
        expect(updatedDocument.operations[1].index).toEqual(1);
    });
    ...
    it('should handle updateNode operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(1);
        expect(updatedDocument.operations[0].type).toBe('UPDATE_NODE');
        expect(updatedDocument.operations[0].input).toStrictEqual(input);
        expect(updatedDocument.operations[0].index).toEqual(0);
    });
    ...
    it('should handle copyNode operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(2);
        expect(updatedDocument.operations[1].type).toBe('COPY_NODE');
        expect(updatedDocument.operations[1].input).toStrictEqual(input);
        expect(updatedDocument.operations[1].index).toEqual(1);
    });
    ...
    it('should handle moveNode operation', () => {
        ...
        expect(updatedDocument.operations).toHaveLength(2);
        expect(updatedDocument.operations[1].type).toBe('MOVE_NODE');
        expect(updatedDocument.operations[1].input).toStrictEqual(input);
        expect(updatedDocument.operations[1].index).toEqual(1);
    });
});
