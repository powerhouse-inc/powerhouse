...
function createVersionedTodoV1() {
const TodoState: ObjectDescriptor = ph.object("TodoState", {
fields: {
"todos": ph.list(ph.ref(() => TodoItem, { required: true }), { required: true })
},
});

const TodoItem: ObjectDescriptor = ph.object("TodoItem", {
fields: {
...
function createVersionedTodoV2() {
const TodoState: ObjectDescriptor = ph.object("TodoState", {
fields: {
"title": ph.String(),
"todos": ph.list(ph.ref(() => TodoItem, { required: true }), { required: true })
...
const VersionedTodoFamily = defineDocumentModelFamily({
  versions: [createVersionedTodoV1(), createVersionedTodoV2()],
  upgrades: [{ toVersion: 2, upgradeReducer(document) { return document; } }],
});

export const VersionedTodoV1 = VersionedTodoFamily.at(1);
export const VersionedTodoV2 = VersionedTodoFamily.at(2);
export const documentModels = VersionedTodoFamily.modules;
export const upgradeManifests = [VersionedTodoFamily.upgradeManifest];
