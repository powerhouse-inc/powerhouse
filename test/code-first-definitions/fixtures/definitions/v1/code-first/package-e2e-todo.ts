...
const PackageTodoFamily = defineDocumentModelFamily({
  versions: [createPackageTodoV1()],
  upgrades: [],
});

export const PackageTodoV1 = PackageTodoFamily.at(1);
export const documentModels = PackageTodoFamily.modules;
export const upgradeManifests = [PackageTodoFamily.upgradeManifest];
