...
describe('UNDO operation', () => {
    it('should undo last operation', () => {
        ...
        expect(document.extendedState.name).toBe('');
    ...
    it('should keep document attributes', () => {
        ...
        expect(document.extendedState.state.count).toBe(0);
        expect(document.extendedState.documentType).toBe('powerhouse/counter');
    });
});
