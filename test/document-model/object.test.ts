...
describe('DocumentModel Class', () => {
    ...
    it('should create an empty document', () => {
        ...
        expect(model.state.id).toMatch(/^[a-zA-Z0-9+\\/]{27}=$/);
    ...
    it('should apply operations operations to the latest spec', () => {
        ...
        model.setOperationName({id:addStateExampleId, name:'SetAuthorName'});
        model.setOperationSchema({id:addStateExampleId, schema:'<SetAuthorName.schema>'});
        model.setOperationDescription({id:addStateExampleId, description:'<SetAuthorName.description>'});
        model.setOperationReducer({id:addStateExampleId, reducer:'<SetAuthorName.reducer>'});
        model.setOperationTemplate({id:addStateExampleId, template:'<SetAuthorName.template>'});
