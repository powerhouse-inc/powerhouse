...
- **profiling:** add batch-size, pyroscope, file output and action-type flags to docs-create.ts ([d95757d75](https://github.com/powerhouse-inc/powerhouse/commit/d95757d75))
- **profiling:** merge switchboard-runtime.sh into switchboard-pyroscope.sh ([389c02441](https://github.com/powerhouse-inc/powerhouse/commit/389c02441))
...
- **switchboard:** initialize pyroscope at top level with wall and CPU profiling ([4d249dada](https://github.com/powerhouse-inc/powerhouse/commit/4d249dada))
...
- **profiling:** rewrite docs-create.ts for new DocumentModel_* subgraph schema ([96de8b1f3](https://github.com/powerhouse-inc/powerhouse/commit/96de8b1f3))
- **profiling:** disable Pyroscope when using bun runtime ([e9e56d5b3](https://github.com/powerhouse-inc/powerhouse/commit/e9e56d5b3))
...
- **switchboard:** restore Sentry capture on profiler init failure and fix README ([25614ff23](https://github.com/powerhouse-inc/powerhouse/commit/25614ff23))
...
- **switchboard,profiling:** address review feedback on profiler and docs-create ([08153ba67](https://github.com/powerhouse-inc/powerhouse/commit/08153ba67))
