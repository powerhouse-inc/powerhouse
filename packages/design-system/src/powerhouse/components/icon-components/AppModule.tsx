...
export default function AppModule(props: IconComponentProps) {
  return (
    <svg
      {...props}
      width="32"
    ...
    >
      <g clipPath="url(#clip0_2488_6549)">
      ...
      <defs>
        ...
        >
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect1_dropShadow_2488_6549"
          />
          <feOffset dy="4" />
          ...
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_2488_6549"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            mode="multiply"
            in2="shape"
            result="effect2_innerShadow_2488_6549"
          />
        </filter>
