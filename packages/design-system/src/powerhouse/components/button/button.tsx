...
export const PowerhouseButton = forwardRef(function PowerhouseButton(
  ...
  const colorStyles = {
    light:
      "bg-gray-200 text-gray-600 hover:text-gray-700 hover:border-gray-300 active:border-slate-100 active:text-gray-600 disabled:text-gray-400 dark:bg-slate-600 dark:text-slate-100 dark:hover:text-slate-100",
