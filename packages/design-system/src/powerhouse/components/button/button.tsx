...
export const PowerhouseButton = forwardRef(function PowerhouseButton(
  ...
  const colorStyles = {
    light:
      "bg-gray-200 text-gray-700 hover-hover active:border-gray-100 active:text-gray-700 disabled:text-gray-400 dark:bg-slate-600 dark:active:border-slate-500 dark:disabled:text-slate-500 dark:active:bg-slate-600 dark:text-slate-100 dark:active:text-slate-100",
    dark: "bg-gray-800 text-gray-50 hover-hover active:border-gray-700 disabled:bg-gray-300 disabled:text-gray-100 dark:bg-slate-100 dark:text-slate-900 dark:active:border-slate-200 dark:disabled:bg-slate-600 dark:disabled:text-slate-100",
