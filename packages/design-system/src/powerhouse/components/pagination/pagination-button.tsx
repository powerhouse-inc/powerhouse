...
export const PaginationButton: React.FC<PaginationButtonProps> = ({
  ...
  const mergedClassName = twMerge(
    "h-8 min-w-8 border border-solid border-gray-300 bg-gray-50 px-3 py-1 text-xs text-gray-900 hover:effect dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100",
    !active && "border-0",
