  ...
  function UploadFileItem(props, ref) {
    ...
    return (
      <div
        ref={ref}
        className={twMerge(
          "flex w-full flex-col gap-0.5 rounded-md border border-gray-100 bg-white p-2 shadow-sidebar dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100",
          className,
        )}
        {...delegatedProps}
      >
