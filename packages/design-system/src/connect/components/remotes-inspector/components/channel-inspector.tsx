    ...
    <div className="flex h-full flex-col gap-3 overflow-auto">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button
            className="flex items-center gap-1 rounded-sm border border-gray-300 bg-gray-50 px-2 py-1 text-sm text-gray-700 hover-hover dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
            onClick={onBack}
            type="button"
          >
        ...
        {onRefresh && (
          <button
            className="flex items-center gap-1 rounded-sm border border-gray-300 bg-gray-50 px-3 py-1.5 text-sm text-gray-700 hover-hover dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
            onClick={onRefresh}
            type="button"
          >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  className="ml-1 rounded-sm border border-gray-300 bg-gray-50 px-2 py-1 text-sm text-gray-700 hover-hover dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
            ...
            <div className="flex gap-2">
              ...
              <button
                className="flex items-center gap-1 rounded-sm border border-gray-300 bg-gray-50 px-3 py-1.5 text-sm text-gray-700 hover-hover disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
