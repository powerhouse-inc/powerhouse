...
export function RemotesInspector({
  ...
  return (
    <div className="flex h-full flex-col gap-2">
      ...
      {addError && (
        <div className="shrink-0 rounded-sm border border-destructive bg-destructive/10 px-3 py-1.5 text-xs text-destructive">
          {addError}
        </div>
      )}
                ...
                return (
                  <th
                    ...
                    className={twMerge(
                      ...
                      isSortable && "cursor-pointer hover:hover-effect",
                    )}
