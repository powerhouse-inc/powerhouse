...
export function RemotesInspector({
  ...
  return (
    <div className="flex h-full flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          {addRemoteManual && (
            <div className="flex items-center gap-1">
              <input
                className="w-[260px] rounded-sm border border-gray-300 px-2 py-1.5 text-sm text-gray-900 placeholder:text-gray-400 dark:border-slate-500 dark:text-slate-50 dark:placeholder:text-slate-500 dark:bg-slate-600"
                disabled={adding}
      ...
      <div className="scrollbar-thin max-h-full overflow-auto rounded-lg border border-gray-300 scrollbar-thumb-gray-300 scrollbar-thumb-rounded-md scrollbar-track-transparent dark:border-slate-500 dark:scrollbar-thumb-slate-600 dark:bg-slate-600">
            ...
            {loading && sortedRemotes.length === 0 ? (
              ...
              sortedRemotes.map((remote) => (
                ...
                >
                  ...
                  <td className="border-l border-gray-300 px-3 py-2 dark:border-slate-500 dark:bg-slate-600">
