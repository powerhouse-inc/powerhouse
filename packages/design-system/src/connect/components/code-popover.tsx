    ...
    >
      ...
      <Portal>
        <Content
          ...
          className="z-50 rounded-lg border border-gray-300 bg-gray-50 p-2 text-xs shadow-tooltip outline-none dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
        >
          {content}
        </Content>
      </Portal>
