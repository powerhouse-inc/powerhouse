...
export function EditorUndoRedoButtons(props: EditorUndoRedoButtonsProps) {
  ...
  const buttonStyles =
    "w-8 h-8 rounded-lg flex justify-center items-center rounded border border-gray-200 bg-white dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100";
  return (
