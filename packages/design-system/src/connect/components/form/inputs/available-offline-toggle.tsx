...
export const AvailableOfflineToggle = forwardRef(
  function AvailableOfflineToggle(
    ...
    return (
      <div className="flex items-center rounded-md border border-gray-200 bg-gray-50 p-3 text-gray-900 dark:border-slate-500 dark:text-slate-50 dark:bg-slate-600">
