...
export function LocationInfo(props: LocationInfoProps) {
  ...
  return (
    <div
      {...divProps}
      className={twMerge(
        "my-3 flex items-center gap-2 rounded-xl border border-gray-100 bg-white p-3 text-gray-800 shadow-sm dark:border-slate-800 dark:bg-slate-800 dark:text-slate-100",
        className,
      )}
    >
      {locationInfo.icon}
