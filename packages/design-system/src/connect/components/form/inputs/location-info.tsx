...
export function LocationInfo(props: LocationInfoProps) {
  ...
  return (
    <div
      {...divProps}
      className={twMerge(
        "my-3 flex items-center gap-2 rounded-xl border border-gray-100 bg-gray-50 p-3 text-gray-800 shadow-sm dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100",
        className,
      )}
    >
      {locationInfo.icon}
