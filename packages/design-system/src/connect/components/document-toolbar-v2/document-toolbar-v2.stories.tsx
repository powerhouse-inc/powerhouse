...
import { DocumentToolbarV2 } from "./document-toolbar-v2.js";

const timelineData = generateLargeTimeline(200);

const meta = {
  title: "Connect/Components/DocumentToolbarV2",
  component: DocumentToolbarV2,
} satisfies Meta<typeof DocumentToolbarV2>;
