...
export function DropZone(props: DropZoneProps) {
  ...
  return (
    ...
    >
      ...
      {enable && isDropTarget && (
        <div className="pointer-events-none fixed inset-0 z-1000 flex min-h-screen w-screen items-center justify-center bg-black/50 dark:bg-slate-900/50">
          <div className="rounded-3xl bg-white p-6 shadow-charcoal dark:bg-slate-800">
