...
export const FormInput = forwardRef(function FormInput(
  ...
  return (
    <div>
      <div
        className={twMerge(
          "mb-1 flex gap-2 rounded-md border border-gray-200 bg-gray-50 p-3 text-black placeholder:text-gray-50 dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100 dark:placeholder:text-slate-900",
      ...
      >
        {icon && (
          <span
            className={twJoin(
              (!isDirty || isError) && "text-slate-200 dark:text-slate-300",
            )}
          >
            {icon}
          </span>
