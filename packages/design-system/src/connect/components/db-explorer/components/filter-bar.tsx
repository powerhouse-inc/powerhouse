...
function FilterClauseComponent({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {showValueInput && (
        <input
          className="min-w-[150px] rounded-sm border border-gray-300 bg-white px-2 py-1 text-xs text-gray-900 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-50"
          type={inputType}
          value={clause.value}
...
export function FilterBar({
  ...
  return (
    <div className="flex shrink-0 flex-col gap-2 rounded-lg border border-gray-300 bg-white p-2 dark:border-slate-600 dark:bg-slate-800">
      <div className="flex items-center justify-between">
        ...
        <button
          className="flex items-center gap-1 rounded-sm border border-gray-300 bg-white px-2 py-1 text-xs text-gray-700 hover:bg-gray-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
