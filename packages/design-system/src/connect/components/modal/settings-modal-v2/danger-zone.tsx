...
function Drive(props: ModifyDrivesProps & { drive: DocumentDriveDocument }) {
  ...
  return (
    <div
      className={cn(
        "mb-4 flex w-96 items-center gap-2 rounded-md border border-gray-200 bg-gray-50 px-3 py-2 shadow-sm last-of-type:mb-0 dark:border-slate-700 dark:bg-slate-800",
        className,
      )}
    >
      {icon}
        ...
        <div className="flex items-baseline gap-x-2 leading-4.5">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 12 12"
              className="size-4 text-gray-400 transition-colors group-hover:text-inherit dark:text-slate-200"
            >
              <path
