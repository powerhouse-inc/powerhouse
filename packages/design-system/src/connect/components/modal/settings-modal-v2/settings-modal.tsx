...
export function SettingsModal(props: Props) {
  ...
  return (
    <Modal
      ...
      {...restProps}
    >
      <div className="flex justify-between border-b border-slate-50 p-4 dark:border-slate-500 dark:bg-slate-600">
      ...
      <div className="flex flex-1">
        ...
        <div className="m-6 flex h-full flex-1 flex-col overflow-hidden rounded-lg border border-slate-50 bg-white dark:border-slate-500 dark:bg-slate-600">
