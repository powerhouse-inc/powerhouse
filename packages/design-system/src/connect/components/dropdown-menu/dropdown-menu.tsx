...
export function ConnectDropdownMenu<TItemId extends string>(
  ...
  return (
    <DropdownMenu onOpenChange={onOpenChange} open={open}>
      ...
      <DropdownMenuContent
        className={twMerge(
          "cursor-pointer rounded-2xl border border-gray-200 bg-white text-sm font-medium text-slate-500 shadow-lg dark:border-slate-500 dark:text-slate-100 dark:bg-slate-600",
          menuClassName,
        )}
      >
