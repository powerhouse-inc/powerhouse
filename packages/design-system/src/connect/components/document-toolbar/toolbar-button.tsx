...
export function ToolbarButton(props: ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={twMerge(
        "grid size-fit place-items-center rounded-lg border border-gray-300 bg-gray-50 p-1 text-gray-900 dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100",
        disabled
