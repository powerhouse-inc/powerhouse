...
export function ToolbarButton(props: ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={twMerge(
        "grid size-fit place-items-center rounded-lg border border-gray-200 bg-white p-1 text-gray-900 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-50",
        disabled
