...
export function ToolbarButton(props: ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={twMerge(
        "grid size-fit place-items-center rounded-lg border border-border bg-background p-1 text-foreground hover:hover-effect active:active-effect disabled:disabled-effect",
        className,
      )}
    >
      {children}
