...
export function Signature(props: SignatureProps) {
  ...
  return (
    <CodePopover
      trigger={
        <span className="flex w-fit cursor-pointer items-center gap-1 rounded-lg border border-gray-200 bg-white px-2 py-1 dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100">
