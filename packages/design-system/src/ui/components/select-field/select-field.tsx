          ...
          <PopoverTrigger asChild={true}>
            ...
            <Button
              ...
              className={cn(
                ...
                "rounded-md border border-gray-300 bg-white dark:border-slate-600 dark:bg-slate-900",
                "hover:border-gray-300 hover:bg-gray-100 dark:hover:border-slate-600 dark:hover:bg-slate-800",
                ...
                disabled && [
                  "pointer-events-auto! cursor-not-allowed bg-gray-50 dark:bg-slate-900",
                  "hover:border-gray-300 hover:bg-gray-50 dark:hover:border-slate-600 dark:hover:bg-slate-900",
                ],
                className,
              )}
              {...props}
