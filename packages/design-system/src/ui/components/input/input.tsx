...
const inputBaseStyles = cn(
  ...
  // Border & Background
  "border border-gray-300 bg-white dark:border-slate-600 dark:bg-slate-900",
  // Padding
  "px-3 py-2",
  // Placeholder
  ...
  "focus:bg-gray-50 dark:focus-visible:ring-slate-300 dark:focus-visible:ring-offset-slate-900 dark:focus:bg-slate-900",
  // Disabled state
