...
const inputBaseStyles = cn(
  ...
  "disabled:border-gray-300 disabled:bg-gray-50 disabled:text-gray-700 dark:disabled:border-slate-600 dark:disabled:bg-slate-800 dark:disabled:text-slate-200",
