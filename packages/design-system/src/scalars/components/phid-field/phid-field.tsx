...
const PHIDFieldWithValidation = withFieldValidation<PHIDFieldProps>(
  PHIDFieldRaw,
  {
    validations: {
      _validPHIDFormat:
...
export const PHIDField = React.forwardRef<HTMLInputElement, PHIDFieldProps>(
  (props, ref) => {
    return <PHIDFieldWithValidation {...props} innerRef={ref} />;
  },
);
