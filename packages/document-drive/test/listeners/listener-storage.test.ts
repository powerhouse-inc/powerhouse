...
describe("InMemoryListenerStorage", () => {
  test("should get listeners for a parentId", async () => {
    const storage = new InMemoryListenerStorage();
...
describe("Listener Manager with Storage", () => {
  ...
  test("should initialize storage", async () => {
    const { listenerManager, storage } = createListenerManager();
