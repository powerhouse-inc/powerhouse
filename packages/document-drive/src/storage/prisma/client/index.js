...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/ale/Documents/moment-work/powerhouse/packages/document-drive/src/storage/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/ale/Documents/moment-work/powerhouse/packages/document-drive/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
...
path.join(process.cwd(), "src/storage/prisma/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
