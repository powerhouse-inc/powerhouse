...
const config = {
  generator: {
    ...
    output: {
      value:
        "/Users/benjaminjordan/projects/powerhouse/powerhouse/packages/document-drive/src/storage/prisma/client",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/Users/benjaminjordan/projects/powerhouse/powerhouse/packages/document-drive/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineSchemaHash:
    "b973e57265383a7127dec57811ef41ddf1192f30398c1d32ee1a425c026d13a8",
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  "src/storage/prisma/client/libquery_engine-debian-openssl-3.0.x.so.node",
);
// file annotations for bundling tools to include these files
