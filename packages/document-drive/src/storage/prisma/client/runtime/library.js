...
var Fo = Z((zm, Lo) => {
  ...
  Lo.exports = {
    supportsColor: Ou,
    stdout: Kn(zn(!0, _o.isatty(1))),
    stderr: Kn(zn(!0, _o.isatty(2))),
  };
});
var $o = Z((Ym, Mo) => {
  "use strict";
...
var go = {
  enabled:
    !co && po == null && mo !== "dumb" && ((Mn != null && Mn !== "0") || fo),
};
function M(e, t) {
  ...
  Ee = (e, t, r) => {
    ...
    if (Bn(e)) {
      ...
      return Object.keys(e).every((n) => {
        let i = e[n];
        return (
          (n in t || (Nr((o = i)) && o[ke]().matcherType === "optional")) &&
          Ee(i, t[n], r)
        );
        var o;
      });
...
var Gn = class e {
    ...
    let o = !1,
      ...
      l =
        !n.some((u) => Ee(u, this.input, a)) || (i && !i(this.input))
          ...
          : {
              matched: !0,
              value: r(o ? (Mr in s ? s[Mr] : s) : this.input, this.input),
            };
  ...
  when(t, r) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: r(this.input, this.input) } : Un,
    );
  }
  otherwise(t) {
...
async function Tu(e) {
  try {
    return (await Qn.default.readdir(e)).find(
...
async function Au() {
  return typeof jr.default.machine == "function"
    ? jr.default.machine()
    : (await Vr("uname -m"))?.trim();
}
function Io(e) {
...
function ii(e) {
  let t = e.e,
    ...
    i = `Please refer to the documentation about Prisma's system requirements: ${Xn("https://pris.ly/d/system-requirements")}`,
  ...
  toString() {
    let { config: t } = this,
      r = t.provider.fromEnvVar
        ...
        : t.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: r, binaryTargets: Ku(t.binaryTargets) }),
      );
...
function nc(e) {
  return {
    datamodel: { models: yi(e.models), enums: yi(e.enums), types: yi(e.types) },
  };
}
function yi(e) {
...
var wi = class {
  ...
  xi = (e) => {
    ...
    return (
      e.getConnectionInfo &&
        (n.getConnectionInfo = oc(t, e.getConnectionInfo.bind(e))),
      n
    );
  },
  ic = (e, t) => ({
...
m.precision = m.sd = function (e) {
  ...
  return (
    r.d ? ((t = vs(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
m.round = function () {
...
var N = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (
      (_[p] > (Y[p] || 0) && c--,
      o == null
        ? ((ae = o = kr.precision), (s = kr.rounding))
        : a
          ? (ae = o + (n.e - i.e) + 1)
          : (ae = o),
      ae < 0)
...
function Ii(e, t, r, n) {
  ...
  if (
    (g
      ? (oe(r, 1, He), n === void 0 ? (n = f.rounding) : oe(n, 0, 8))
...
function Uc(e) {
  var t,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : oe(e, 1, He),
    (n = Math.ceil(e / b)),
    this.crypto)
  )
  ...
  dn = class {
    ...
    write(t) {
      ...
      (this.hasError && r.underline().setColor(t.context.colors.red),
        t.write(r).write(Os).write(this.value));
    }
  };
...
function Ot(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      Fs[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
...
var Rp = (e) => e,
  ...
  P = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++Cp }),
          e.__id
        );
      },
...
async function va(e, t) {
  ...
  if (
    (Xp("enginePath", n), n !== void 0 && e === "binary" && ni(n), n !== void 0)
  )
  ...
  let o = await tt(),
    ...
    p;
  throw (
    a && l ? (p = wa(c)) : l ? (p = ba(c)) : u ? (p = Ea(c)) : (p = xa(c)),
...
\`\`\``
      : "",
    c = (0,
    Mi.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var La = {
  ...
  "@prisma/engines-version":
    "5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053",
  ...
  return new Promise((s, a) => {
    let l = r.request(e, n, (u) => {
      ...
      (c >= 301 &&
        c <= 399 &&
        p &&
        (p.startsWith("http") === !1 ? s(Gi(`${o}${p}`, t)) : s(Gi(p, t))),
...
var zi,
  Va = {
    async loadLibrary(e) {
      ...
      if (r === void 0)
        throw new R(
          `The \`adapter\` option for \`PrismaClient\` is required in this context (${wn().prettyName})`,
          t,
        );
      if (n === void 0)
    ...
    async getCurrentBinaryTarget() {
      {
        ...
        if (!Ba.includes(t))
          throw new R(
            `Unknown ${ce("PRISMA_QUERY_ENGINE_LIBRARY")} ${ce(W(t))}. Possible binaryTargets: ${Me(Ba.join(", "))} or a path to the query engine library.
...
${a.backtrace}`,
    ...
    buildQueryError(t) {
      if (t.user_facing_error.is_panic)
        return new le(
          Yi(this, t.user_facing_error.message),
          this.config.clientVersion,
        );
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: xd(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n);
  }
  ...
  if (i) {
    ...
    s?.hasField(n)
      ...
      : a?.hasField(n)
        ...
        : l?.hasField(n) &&
          ((o = "omit"), l.getField(n)?.markAsError(), qd(l, e.outputType));
  }
  t.addErrorMessage((s) => {
...
function Ar({ select: e, include: t, ...r } = {}, n) {
  ...
  return (
    ...
    { arguments: rl(r, n), selection: Gd(e, t, i, n) }
  );
}
function Gd(e, t, r, n) {
  return e
    ...
    (r) => {
      ...
      if (Array.isArray(r)) {
        ...
        switch (t) {
          ...
          case "mysql": {
            ((n = r.sql),
              (i = { values: Ir(r.values), __prismaRawParameters__: !0 }));
            break;
          }
          case "cockroachdb":
          case "postgresql":
    ...
    constructor(n) {
      ...
      let o = {
          rootEnvPath:
            ...
            Or.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            Or.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = xi(n.adapter);
      ...
      let a =
        (!s && Jt(o, { conflictCheck: "none" })) || e.injectableEdgeEnv?.();
      try {
        let l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0;
