...
var di = {
  enabled:
    !ui && ci == null && pi !== "dumb" && ((Yr != null && Yr !== "0") || fi),
};
function q(e, t) {
...
R.inverseTangent = R.atan = function () {
  ...
  if (u.isFinite()) {
    ...
    if (u.abs().eq(1) && h + 4 <= wn)
      return ((s = fe(g, h + 4, x).times(0.25)), (s.s = u.s), s);
  } else {
    if (!u.s) return new g(NaN);
    if (h + 4 <= wn) return ((s = fe(g, h + 4, x).times(0.5)), (s.s = u.s), s);
  }
  for (
    g.precision = a = h + 10,
      g.rounding = 1,
...
R.precision = R.sd = function (e) {
  ...
  return (
    r.d ? ((t = zi(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
R.round = function () {
...
`);
  return t.reduce(function (r, n) {
    var i = cu(n) || fu(n) || gu(n) || bu(n) || yu(n);
    return (i && r.push(i), r);
  }, []);
}
var lu =
...
function mt(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      lo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
...
var Ou = (e) => e,
  ...
  D = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++ku }),
          e.__id
        );
      },
...
function Kt({ select: e, include: t, ...r } = {}, n) {
  ...
  return (
    ...
    { arguments: fs(r, n), selection: kc(e, t, i, n) }
  );
}
function kc(e, t, r, n) {
  return e
