// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/property/input/date-range-property.spec.ts. MIT; see ../../../../../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import { describe, expect, it } from "vitest";

import { dateRangeUtils } from "../../../../../../../upstream/framework/lib/property/input/date-range-property.js";
...
describe("dateRangeUtils.resolve", () => {
  ...
  it("resolves last_24_hours to ~1 day ago with no upper bound", () => {
    const { after, before } = dateRangeUtils.resolve({
