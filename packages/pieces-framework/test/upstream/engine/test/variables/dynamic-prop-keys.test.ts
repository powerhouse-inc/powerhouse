// Vendored from activepieces/activepieces@0.91.0 packages/server/engine/test/variables/dynamic-prop-keys.test.ts. MIT; see ../../../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import { Property } from "../../../../../upstream/framework/index.js";
import { dynamicPropKeys } from "../../../../../upstream/engine/lib/helper/dynamic-prop-keys.js";
import { propsProcessor } from "../../../../../upstream/engine/lib/variables/props-processor.js";
import { PropertyExecutionType } from "../../../../../src/host/shared-shim.js";

describe("dynamicPropKeys", () => {
  it("escapes react-hook-form reserved characters reversibly", () => {
    const props = {
      "employee.firstName": Property.ShortText({
        displayName: "First name",
        required: true,
      }),
      "columns[0]": Property.ShortText({
        displayName: "Column",
        required: false,
      }),
      "weird~\"'key": Property.ShortText({
        displayName: "Weird",
        required: false,
      }),
      "field~1name": Property.ShortText({
        displayName: "Literal token",
        required: false,
      }),
  ...
  it("never mutates keys that did not come from escapePropsKeys", () => {
    expect(dynamicPropKeys.unescapeInputKeys({ "field~1name": "raw" })).toEqual(
      { "field~1name": "raw" },
    );
  });

  it("leaves non-object dynamic values untouched", () => {
    expect(dynamicPropKeys.unescapeInputKeys("{{trigger.body}}")).toEqual(
      "{{trigger.body}}",
    );
      ...
      await propsProcessor.applyProcessorsAndValidators(
        ...
        false,
        {
          fields: {
            ...
            schema: {
              "~ap~employee~1firstName": Property.ShortText({
                displayName: "First name",
                required: true,
              }),
              "~ap~employee~1age": Property.Number({
                displayName: "Age",
                required: true,
              }),
            },
