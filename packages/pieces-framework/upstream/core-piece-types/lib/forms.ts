// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/forms.ts. MIT; see ../../../LICENSE.
...
export const FileResponseInterface = z.union([
  FileResponseInterfaceV1,
  FileResponseInterfaceV2,
]);
