// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/ai-providers.ts. MIT; see ../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import { AIProviderName, isNil, unique } from "../../core-utils/index.js";
...
export type BedrockProviderAuthConfig = z.infer<
  typeof BedrockProviderAuthConfig
>;
...
export type OpenAICompatibleProviderConfig = z.infer<
  typeof OpenAICompatibleProviderConfig
>;
...
export type CloudflareGatewayProviderConfig = z.infer<
  typeof CloudflareGatewayProviderConfig
>;
...
export type OpenAiCompatibleVendorConfig = z.infer<
  typeof OpenAiCompatibleVendorConfig
>;
...
export type AIProviderWithoutSensitiveData = z.infer<
  typeof AIProviderWithoutSensitiveData
>;
...
export type GetProviderConfigResponse = z.infer<
  typeof GetProviderConfigResponse
>;
...
const REASONING_OPTIONAL_CHAT_MODELS: readonly string[] =
  ANTHROPIC_OPENROUTER_CHAT_MODELS.map(
    (model) => `${AIProviderName.ANTHROPIC}/${model}`,
  );

export const ALLOWED_CHAT_MODELS_BY_PROVIDER: Partial<
...
function curatedChatModelIds(): string[] {
  return unique([
    ...
    ...Object.values(ALLOWED_CHAT_MODELS_BY_PROVIDER).flatMap(
...
const WEB_SEARCH_MODE_BY_PROVIDER: Partial<
  Record<AIProviderName, AIWebSearchMode>
> = {
...
export const OPENAI_COMPATIBLE_VENDOR_BASE_URLS: Record<
...
> = {
  ...
  [AIProviderName.ANTHROPIC]: buildProviderCapabilities(
    AIProviderName.ANTHROPIC,
  ),
  [AIProviderName.OPENROUTER]: buildProviderCapabilities(
  ...
  [AIProviderName.CLOUDFLARE_GATEWAY]: buildProviderCapabilities(
  ...
  [AIProviderName.ACTIVEPIECES]: buildProviderCapabilities(
    AIProviderName.ACTIVEPIECES,
  ),
