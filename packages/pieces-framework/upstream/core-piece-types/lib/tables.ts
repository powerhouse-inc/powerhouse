// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/tables.ts. MIT; see ../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import type { Cursor } from "../../core-utils/index.js";
import {
  BaseModelSchema,
  Nullable,
  NullableEnum,
...
export type CreateTableWebhookRequest = z.infer<
  typeof CreateTableWebhookRequest
>;
...
export type ListRecordsRequest = Omit<
  z.infer<typeof ListRecordsRequest>,
  "cursor"
