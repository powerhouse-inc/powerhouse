// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/agents.ts. MIT; see ../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import type { AIProviderName } from "../../core-utils/index.js";
...
export type PredefinedInputsStructure = z.infer<
  typeof PredefinedInputsStructure
>;
...
export const AgentStepBlock = z.union([
...
function toValidToolName(name: string): string {
  ...
  return PROVIDER_TOOL_NAME_PATTERN.test(generated)
    ? generated
    : createToolName(`tool_${name}`);
}
...
function toProviderSafeIdentifier({
  name,
  fallback,
}: {
  name: string;
