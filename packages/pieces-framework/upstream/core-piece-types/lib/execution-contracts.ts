// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/execution-contracts.ts. MIT; see ../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import type { ApId } from "../../core-utils/index.js";
import {
  BaseModelSchema,
  DateOrString,
  Nullable,
...
export const ExactVersionType = z
  .string()
  .check(z.regex(new RegExp(EXACT_VERSION_PATTERN)));
export const VersionType = z
  .string()
  .check(z.regex(new RegExp(VERSION_PATTERN)));
...
export const PublicPiecePackage = z.union([
  OfficialPiecePackage,
  CustomNpmPiecePackage,
]);
export type PublicPiecePackage = OfficialPiecePackage | CustomNpmPiecePackage;

export const PiecePackage = z.union([
  PrivatePiecePackage,
  OfficialPiecePackage,
  CustomNpmPiecePackage,
]);
