// Vendored from activepieces/activepieces@0.91.0 packages/core/piece-types/src/lib/app-connection.ts. MIT; see ../../../LICENSE.
...
export type OIDCConnectionValue<
  T extends Record<string, unknown> = Record<string, unknown>,
> = {
      ...
      : T extends AppConnectionType.PLATFORM_OAUTH2
        ...
        : T extends AppConnectionType.OAUTH2
          ...
          : T extends AppConnectionType.CUSTOM_AUTH
            ...
            : T extends AppConnectionType.OIDC
              ? OIDCConnectionValue<PropsType>
