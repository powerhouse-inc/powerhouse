// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/piece-metadata.ts. MIT; see ../../../LICENSE.
...
import type { LocalesEnum } from "../../core-utils/index.js";
import type { WebhookHandshakeConfiguration } from "../../core-piece-types/index.js";
import {
  PackageType,
  PieceCategory,
  PieceType,
...
import type { ContextVersion } from "./context/versioning.js";
import type { OutputSchema } from "./output-schema.js";

const I18nForPiece = z.optional(
  z.record(z.string(), z.record(z.string(), z.string())),
);
export type I18nForPiece =
  | Partial<Record<LocalesEnum, Record<string, string>>>
  | undefined;
...
export const ActionClassification = z.enum([
  "READ",
  "SEARCH",
  "WRITE",
  "DESTRUCTIVE",
...
export const READ_ONLY_CLASSIFICATIONS: readonly ActionClassification[] = [
  "READ",
  "SEARCH",
];

export const isReadOnlyClassification = (
  classification: ActionClassification | undefined,
): boolean =>
  classification !== undefined &&
  READ_ONLY_CLASSIFICATIONS.includes(classification);

export const PropertyGroupDisplay = z.enum([
  "tabs",
  "section",
  "summary",
  "builder",
