// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/context/index.ts. MIT; see ../../../../LICENSE.
...
import type { PieceAuthProperty } from "../property/authentication/index.js";
import type { PopulatedFlowSummary } from "../../../core-piece-types/index.js";
...
type ExtractCustomAuthProps<T> =
  T extends CustomAuthProperty<infer Props> ? Props : never;

type ExtractOIDCProps<T> = T extends OIDCProperty<infer Props> ? Props : never;

type ExtractOAuth2Props<T> =
  T extends OAuth2Property<infer Props> ? Props : never;
...
export type FlowsContext = {
  ...
  ): Promise<SeekPage<PopulatedFlowSummary>>;
  current: {
    id: string;
    version: {
      id: string;
...
export function isPieceServerContextError(
  error: unknown,
): error is PieceServerContextError {
