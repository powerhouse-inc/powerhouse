// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/property/util.ts. MIT; see ../../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import type { PiecePropertyMap } from "./index.js";
...
import { AUTHENTICATION_PROPERTY_NAME } from "../../../core-piece-types/index.js";
...
function buildSchema(
  ...
  for (const [name, property] of entries) {
    switch (property.type) {
      case PropertyType.MARKDOWN:
        propsSchema[name] = z.optional(
          z.union([z.null(), z.undefined(), z.never(), z.unknown()]),
        );
        break;
      ...
      case PropertyType.DROPDOWN:
        propsSchema[name] = z.unknown().check(
          z.refine((val) => val !== null && val !== undefined, {
  ...
  if (auth && requireAuth) {
    propsSchema[AUTHENTICATION_PROPERTY_NAME] = z
      .string()
      .check(z.minLength(1));
  }
