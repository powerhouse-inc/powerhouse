// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/property/authentication/index.ts. MIT; see ../../../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.

import * as z from "zod/mini";
import { BasicAuthProperty } from "./basic-auth-prop.js";
import type { CustomAuthProps } from "./custom-auth-prop.js";
import { CustomAuthProperty } from "./custom-auth-prop.js";
import type { OIDCAuthProps } from "./oidc-prop.js";
import { OIDCProperty } from "./oidc-prop.js";
import { SecretTextProperty } from "./secret-text-property.js";
import { PropertyType } from "../input/property-type.js";
import type { OAuth2Props } from "./oauth2-prop.js";
import { OAuth2Property } from "./oauth2-prop.js";
import { isNil } from "../../../../core-utils/index.js";
import { AppConnectionType } from "../../../../core-piece-types/index.js";
...
export function getAuthPropertyForValue({
  authValueType,
  pieceAuth,
  ...
  return (
    pieceAuth.find(
      (auth) => authConnectionTypeToPropertyType[authValueType] === auth.type,
    ) ?? pieceAuth.at(0)
  );
}
...
const authConnectionTypeToPropertyType: Record<
  AppConnectionType,
