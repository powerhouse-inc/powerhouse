// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/property/authentication/oidc-prop.ts. MIT; see ../../../../../LICENSE.
...
} from "../input/dropdown/static-dropdown.js";
...
export type OIDCProperty<T extends OIDCAuthProps> = BasePieceAuthSchema<
  StaticPropsValue<T>
> & {
  props: T;
} & TPropertyValue<StaticPropsValue<T>, PropertyType.OIDC, true>;
