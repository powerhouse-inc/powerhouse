// Vendored from activepieces/activepieces@0.91.0 packages/pieces/framework/src/lib/trigger/trigger.ts. MIT; see ../../../../LICENSE.
...
> = (ctx: OnStartContext<PieceAuth, TriggerProps>) => Promise<unknown | void>;
...
export type WebhookRenewConfiguration = z.infer<
...
> implements TriggerBase {
  constructor(
    ...
    public readonly onStart: OnStartRunner<
      ExtractPieceAuthPropertyTypeForMethods<PieceAuth>,
      TriggerProps
    >,
    public readonly run: (
      ctx: TestOrRunHookContext<
        ExtractPieceAuthPropertyTypeForMethods<PieceAuth>,
        TriggerProps,
        TS
      >,
