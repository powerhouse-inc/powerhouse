// Vendored from activepieces/activepieces@0.91.0 packages/core/utils/src/lib/byte-lru-cache.ts. MIT; see ../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import { isNil } from "./utils.js";

export function createByteLruCache<T>({
  budgetBytes,
}: CreateByteLruCacheParams): ByteLruCache<T> {
