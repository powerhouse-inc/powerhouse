// Vendored from activepieces/activepieces@0.91.0 packages/core/utils/src/lib/ssrf-ip-classifier.ts. MIT; see ../../../LICENSE.
...
function isInAllowList({
  ...
  return allowList.some(
    (entry) => entry.includes("/") && matchesCidr({ addr, cidr: entry }),
  );
}
