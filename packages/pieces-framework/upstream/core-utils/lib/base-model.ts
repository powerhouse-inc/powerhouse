// Vendored from activepieces/activepieces@0.91.0 packages/core/utils/src/lib/base-model.ts. MIT; see ../../../LICENSE.
...
export const Nullable = <T extends z.ZodMiniType>(schema: T) =>
  z.optional(z.nullable(schema));

export function NullableEnum<T extends Record<string, string | number>>(
  enumObj: T,
) {
