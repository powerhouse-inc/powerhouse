// Vendored from activepieces/activepieces@0.91.0 packages/server/engine/src/lib/helper/dynamic-prop-keys.ts. MIT; see ../../../../LICENSE.
// Generated by scripts/sync-upstream.mts — do not edit by hand.
import { isObject } from "../../../core-utils/index.js";
import type { InputPropertyMap } from "../../../framework/index.js";
...
function escapeKey(key: string): string {
  ...
  return (
    ESCAPED_KEY_MARKER +
    key.replace(/[~.[\]"']/g, (char) => ESCAPE_SEQUENCES[char])
  );
}
...
function unescapeKey(key: string): string {
  ...
  return key
    .slice(ESCAPED_KEY_MARKER.length)
    .replace(/~[0-5]/g, (sequence) => UNESCAPE_SEQUENCES[sequence]);
}
