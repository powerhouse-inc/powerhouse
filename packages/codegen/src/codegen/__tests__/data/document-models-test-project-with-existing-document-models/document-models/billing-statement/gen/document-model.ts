      ...
      modules: [
        {
          ...
          operations: [
            ...
            },
            {
              ...
              errors: [
                {
                  id: "invalidStatusTransition",
                  name: "InvalidStatusTransition",
                  code: "INVALID_STATUS_TRANSITION",
                  description:
                    "Cannot transition from current status to the requested status",
                  template: "",
                },
                {
                  id: "statusAlreadySet",
          ...
          operations: [
            {
              ...
              template: "",
              reducer:
                "const existingItem = state.lineItems.find(item => item.id === action.input.id); if (existingItem) { throw new DuplicateLineItem('Line item already exists'); } state.lineItems.push({ ...action.input, lineItemTag: [] });",
              errors: [
                {
                  id: "duplicateLineItem",
                  name: "DuplicateLineItem",
                  code: "DUPLICATE_LINE_ITEM",
                  description: "Line item with this ID already exists",
                  template: "",
                },
                {
                  id: "invalidStatusTransition",
                  ...
                  code: "INVALID_STATUS_TRANSITION",
                  description:
                    "Cannot add line items to a billing statement in this status",
                  template: "",
                },
              ],
              examples: [],
