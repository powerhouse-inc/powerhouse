...
export const EXPECTED_EDITOR_CONTENT = `import { DocumentToolbar } from "@powerhousedao/design-system";
import {
  Button,
  Form,
  FormLabel,
...
export const EXPECTED_EDITOR_CONTENT_NO_DOCUMENT_TYPES = `import { DocumentToolbar } from "@powerhousedao/design-system";
import {
  Button,
  Form,
  FormLabel,
