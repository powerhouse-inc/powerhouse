...
export type NodeKind = typeof DRIVE | typeof FILE | typeof FOLDER;
...
export type DriveNodeActionHandlers = {
...
export type UseDriveNodeActionHandlers = (
  actions: DriveNodeActions,
) => DriveNodeActionHandlers;
