...
describe("Budget Statement account reducer", () => {
  ...
  it("should update account", () => {
    ...
    expect(updatedDocument.operations.global[0].input).toEqual(inputToUpdate);
    expect(updatedDocument.operations.global[0].index).toEqual(0);
  ...
  it("should delete account", () => {
    ...
    expect(updatedDocument.operations.global[0].input).toEqual(inputToDelete);
    expect(updatedDocument.operations.global[0].index).toEqual(0);
  ...
  it("should throw exception if adding account with same address", () => {
    ...
    document = reducer(document, creators.addAccount(inputWithTheSameAddress));
