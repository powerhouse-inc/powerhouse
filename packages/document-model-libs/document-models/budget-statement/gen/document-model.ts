...
export const documentModel: DocumentModelState = {
  ...
  extension: "phbs",
  description:
    "The BudgetStatement module manages the state and actions related to budget statements, which are documents that track the financial transactions of an organization over a month.",
  author: {
    name: "Powerhouse",
