  ...
  return (
    <DocumentEditor mode={context.theme}>
      <EditorToolbar
        ...
        key="toolbar"
        left={[
          <ToolbarButton key="undo" onClick={() => dispatch(actions.undo(1))}>
            ↺ undo
          </ToolbarButton>,
          <ToolbarButton key="redo" onClick={() => dispatch(actions.redo(1))}>
            ↻ redo
          </ToolbarButton>,
        ]}
        right={[<ToolbarButton key="rev">revision history</ToolbarButton>]}
      />
      <EditorWorksheet key="sheet">
        <div className="editor-worksheet--header-left" key="header-left">
          <TextInput
            key="doc-title"
          ...
          <p key="lastModified">
            Last Modified:{" "}
            {document.lastModified.toString().slice(0, 16).replace("T", " ")}{" "}
            UTC &ndash; Version: {document.revision.global}
          </p>
        </div>
        <div className="editor-worksheet--header-right" key="header-right">
          <TextInput
            key="doc-title"
