 ...
 * `.default` (the CJS `module.exports`) — so server code imports it as a
 * default export instead. This augmentation adds the matching default
 * export to the typings; default-import interop works identically in
 * Node ESM, vite, and vitest.
 */
