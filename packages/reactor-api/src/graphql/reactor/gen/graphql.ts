...
export type DocumentModelResultPageResolvers<ContextType = Context, ParentType extends ResolversParentTypes['DocumentModelResultPage'] = ResolversParentTypes['DocumentModelResultPage']> = ResolversObject<{
  ...
  items?: Resolver<ReadonlyArray<ResolversTypes['DocumentModelState']>, ParentType, ContextType>;
  totalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type DocumentModelStateResolvers<ContextType = Context, ParentType extends ResolversParentTypes['DocumentModelState'] = ResolversParentTypes['DocumentModelState']> = ResolversObject<{
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  namespace?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  specification?: Resolver<Maybe<ResolversTypes['JSONObject']>, ParentType, ContextType>;
...
export function SearchFilterInputSchema(): z.ZodObject<Properties<SearchFilterInput>> {
  return z.object({
...
export function ViewFilterInputSchema(): z.ZodObject<Properties<ViewFilterInput>> {
  return z.object({
