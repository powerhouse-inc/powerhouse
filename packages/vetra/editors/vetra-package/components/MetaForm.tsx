      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-300 px-3 py-2 placeholder:text-gray-700 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-slate-500 dark:placeholder:text-slate-200"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full resize-none rounded-md border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-slate-500"
          />
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-3 py-2 placeholder:text-gray-700 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-slate-500 dark:placeholder:text-slate-200"
            />
            <div className="flex min-h-[80px] flex-wrap gap-2 rounded-md border border-gray-300 p-3 dark:border-slate-500">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            readOnly
            className="w-full cursor-not-allowed rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-gray-500 placeholder:text-gray-700 dark:border-slate-500 dark:bg-slate-800 dark:text-slate-400 dark:placeholder:text-slate-200"
          />
        </div>
