          ...
          <div className="space-y-2">
            ...
            <div className="flex min-h-[80px] flex-wrap gap-2 rounded-md border border-gray-300 p-3 dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100">
              {keywords.map((keyword) => (
                <span
                  key={keyword.id}
                  className="inline-flex items-center rounded-sm border border-blue-300 bg-blue-100 px-2 py-0.5 text-xs text-blue-900 dark:border-blue-600 dark:bg-blue-800 dark:text-blue-100"
                >
                  {keyword.label}
                  <button
                    onClick={() => {
