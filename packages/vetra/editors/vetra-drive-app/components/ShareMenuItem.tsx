      ...
      <div className="flex items-center gap-2">
        ...
        >
          <input
            ...
            readOnly
            value={url}
            className="w-[300px] truncate rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs text-gray-800 underline outline-none placeholder:text-gray-700 dark:border-slate-500 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-200"
          />
          {showTooltip && (
