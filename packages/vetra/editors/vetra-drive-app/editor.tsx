...
export function BaseEditor(props: EditorProps) {
  ...
  return showDocumentEditor ? (
    ...
    <div
      style={{ height: "100%" }}
      className="bg-gray-50 p-6 after:pointer-events-none after:absolute after:inset-0 after:bg-blue-500 after:opacity-0 after:transition after:content-[''] dark:bg-slate-800 dark:after:bg-blue-50"
    >
      <DriveExplorer
        driveId={driveId}
        driveName={driveName}
