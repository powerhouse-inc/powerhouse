    ...
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <input
          ...
          disabled={isReadOnly}
          className={twMerge(
            "w-full rounded-md border border-gray-300 px-3 py-2 placeholder:text-gray-400 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-slate-600 dark:placeholder:text-slate-500",
            isReadOnly
        ...
        <div className="mb-4">
          <label htmlFor="drag-and-drop-enabled" className="flex items-center">
            <input
              ...
              disabled={isReadOnly}
              className={twMerge(
                "mr-2 size-4 rounded-sm border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-slate-600 dark:text-blue-100",
