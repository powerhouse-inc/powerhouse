...
function mockGetPHConfig(): PowerhouseConfig {
  return {
    logLevel: "verbose",
    skipFormat: true,
    documentModelsDir: `${process.cwd()}/document-models`,
    editorsDir: `${process.cwd()}/editors`,
    processorsDir: `${process.cwd()}/processors`,
    subgraphsDir: `${process.cwd()}/subgraphs`,
    importScriptsDir: `${process.cwd()}/import-scripts`,
  };
}

/**
 * Helper to create an OperationWithContext from test data.
 * The operation field is stubbed since CodegenProcessor only uses context.
 */
function makeOperation(
  ...
  return {
    operation: {} as OperationWithContext["operation"],
    context: {
      documentId,
      documentType,
      scope: "global",
      branch: "main",
      resultingState: state != null ? JSON.stringify(state) : undefined,
      ordinal: 1,
    },
  };
}
...
describe("CodegenProcessor E2E Tests", () => {
  ...
  describe("Document Editor E2E", () => {
    it("should process valid document-editor strand and call generateEditor with correct arguments", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/document-editor", {
        global: validState,
      });
  ...
  describe("Document Model E2E", () => {
    it("should process valid document-model strand and call model and manifest codegen functions", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/document-model", {
        global: validState,
      });
  ...
  describe("Processor E2E", () => {
    it("should process valid analytics processor strand and call generateProcessor", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/processor", {
        global: validState,
      });
  ...
  describe("App E2E", () => {
    it("should process valid app strand without dragAndDrop", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/app", {
        global: validState,
      });
  ...
  describe("Subgraph E2E", () => {
    it("should process valid subgraph strand and call generateSubgraph with null", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/subgraph", {
        global: validState,
      });
  ...
  describe("Package E2E", () => {
    it("should process valid package strand and call generateManifest", async () => {
      ...
      const op = makeOperation("test-doc-1", "powerhouse/package", validState);
  ...
  describe("Multi-Strand E2E", () => {
    it("should process multiple valid strands of different types in one batch", async () => {
      ...
      const ops = [
        makeOperation("test-doc-1", "powerhouse/document-editor", {
          global: editorState,
        }),
        makeOperation("test-doc-2", "powerhouse/subgraph", {
          global: subgraphState,
        }),
      ];
    ...
    it("should process valid strands and skip invalid strands in the same batch", async () => {
      ...
      const ops = [
        makeOperation("test-doc-1", "powerhouse/document-editor", {
          global: validEditorState,
        }),
        makeOperation("test-doc-2", "powerhouse/subgraph", {
          global: invalidSubgraphState,
        }),
      ];
  ...
  describe("Edge Cases E2E", () => {
    it("should not process strand with unsupported document type", async () => {
      ...
      const op = makeOperation("test-doc-1", "unsupported/document-type", {
        name: "Test",
      });
    ...
    it("should not process strand with missing documentId", async () => {
      ...
      const op = makeOperation("", "powerhouse/document-editor", {
        global: validState,
      });
    ...
    it("should debounce generate calls for same strand", async () => {
      ...
      const firstOp = makeOperation(
        "test-doc-1",
        "powerhouse/package",
        firstState,
      );

      const secondOp = makeOperation(
        "test-doc-1",
        "powerhouse/package",
        secondState,
      );

      await processor.onOperations([firstOp]);
      await processor.onOperations([secondOp]);
