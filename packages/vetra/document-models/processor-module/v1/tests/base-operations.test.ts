...
describe("BaseOperations Operations", () => {
  ...
  it("should handle addProcessorApp operation", () => {
    const document = utils.createDocument();
    const input = generateMock(AddProcessorAppInputSchema());
  ...
  it("should handle removeProcessorApp operation", () => {
    const document = utils.createDocument();
    const input = generateMock(RemoveProcessorAppInputSchema());

    const updatedDocument = reducer(document, removeProcessorApp(input));
