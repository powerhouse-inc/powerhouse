  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 p-3 dark:bg-slate-800">
        ...
        <button
          className="flex items-center gap-x-2 rounded-md border border-gray-300 bg-transparent px-3 py-1 text-sm font-medium text-gray-900 transition-colors hover:effect dark:border-slate-500 dark:bg-slate-600 dark:text-slate-100"
...
function DriveAboutEntry({ drive }: { drive: DocumentDriveDocument }) {
  ...
  return (
    <li className="text-sm text-gray-700 dark:text-slate-200">
      ...
      {info.status === "error" && (
        <div className="mt-1 text-xs text-red-500 dark:text-red-50">
