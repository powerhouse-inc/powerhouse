import {
  useAcceptedCookies,
  useCookieBanner,
} from "../hooks/preferences-store.js";
...
export const CookieBanner = () => {
  ...
  return (
    <div className="absolute inset-0 z-10000 backdrop-blur-sm">
      <div className="absolute inset-0 bg-primary opacity-15" />
      <div className="absolute inset-x-0 bottom-0 flex justify-center bg-background px-10 pt-10 pb-16 shadow-lg">
        <PHCookieBanner
