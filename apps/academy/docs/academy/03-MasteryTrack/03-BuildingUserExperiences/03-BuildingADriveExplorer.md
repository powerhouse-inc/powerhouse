...
- Follow the [Get Started guide](/academy/MasteryTrack/ManualTodoTutorial/DefineToDoListDocumentModel) to create your TodoList document model specification.
...
- Follow the [Build TodoList Editor guide](/academy/MasteryTrack/ManualTodoTutorial/BuildToDoListEditor) to implement your editor components.
