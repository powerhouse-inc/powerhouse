...
If you need to review the document model specification steps, see [Define ChatRoom Document Model](/academy/MasteryTrack/ExampleUsecases/Chatroom/DefineChatroomDocumentModel).
