  ...
  choices={[
    {
      ...
      explanation: "The library is just an npm package — closing an app doesn't uninstall code. It can still be imported anywhere.",
    },
    {
      label: "The drives sidebar, the mounted editor, and the sync loop.",
      correct: true,
      explanation: "Those all live inside Connect. The Reactor engine is embedded in Connect; without Connect running, there is no running session.",
    },
    {
      label: "The document models — they need Connect to stay defined.",
      explanation: "Document models are schema definitions, not runtime state. They exist in your package regardless of whether Connect is open.",
    },
    {
      label: "The operation log stored on disk.",
      explanation: "Persisted operations live in the local Reactor store, not in Connect's process. They survive restarts.",
    },
  ]}
/>
...
<Cards>
  <Card title="Drive apps" href="/academy/Learn/connect/drive-apps" />
  <Card title="Back to: Editor hooks and state" href="/academy/Learn/editors/editor-hooks-and-state" />
</Cards>
