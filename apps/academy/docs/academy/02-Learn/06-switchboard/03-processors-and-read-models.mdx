  ...
  choices={[
    {
      ...
      explanation: 'That\'s a count across the entire history. Doing it in the reducer couples the document\'s state size to its age.',
    },
    {
      label: 'Computing the total number of completed todos — processor.',
      correct: true,
      explanation: 'Aggregations like this are exactly what processors are built for.',
    },
    {
      label: 'Sending an email when a todo is assigned — reducer.',
      explanation: 'Reducers are pure — they can\'t send email. This belongs in a processor.',
    },
    {
      label: 'Validating that a todo title isn\'t empty — processor.',
      explanation: 'Validation runs before the action becomes an operation. That\'s reducer territory.',
    },
  ]}
...
<Cards>
  <Card title="Sync and collaborate" href="/academy/Learn/sync/sync-and-collaborate" />
  <Card title="Back to: Subgraphs" href="/academy/Learn/switchboard/subgraphs" />
</Cards>
