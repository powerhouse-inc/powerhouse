...
<Quiz
  ...
  choices={[
    {
      label: "A's new operations are queued locally and will be replayed to peers when A reconnects.",
      correct: true,
      explanation: 'The local log is always the source of truth. Peers catch up later.',
    },
    {
      label: "A's UI is frozen because it can't reach the server.",
      explanation: 'Offline-first means the UI keeps responding against the local log.',
    },
    {
    ...
    },
    {
      ...
      explanation: 'Both sides\' operations survive — neither is privileged over the other.',
    },
  ]}
...
<Cards>
  <Card title="Go deeper: reducers in depth" href="/academy/Learn/deep-dives/reducers-in-depth" />
  <Card title="Go deeper: processors and read models" href="/academy/Learn/switchboard/processors-and-read-models" />
</Cards>
