...
Reducers are the one part of a <Term>Powerhouse</Term> app that *must* be pure. Everything downstream — sync, replay, undo, audit — assumes that running the same reducer against the same inputs produces the same outputs, forever.
...
<Quiz
  ...
  choices={[
    ...
    },
    {
      ...
      correct: true,
      explanation: 'Each user has their own cursor. Local scope keeps it out of the shared log.',
    },
    {
    ...
    },
    {
      ...
      correct: true,
      explanation: 'UI preferences should never sync to peers — local scope is ideal.',
    },
  ]}
...
<Cards>
  ...
  <Card title="Back to Foundations" href="/academy/Learn/foundations/what-is-powerhouse" />
</Cards>
