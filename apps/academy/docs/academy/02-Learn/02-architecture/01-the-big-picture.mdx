...
<Cards>
  <Card title="Host applications" href="/academy/Learn/architecture/host-applications" />
  <Card title="Back to: Thinking in operations" href="/academy/Learn/foundations/thinking-in-operations" />
</Cards>
