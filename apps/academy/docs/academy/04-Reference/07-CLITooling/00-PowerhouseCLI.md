...
### Flags
**Code First** - Create an authored TypeScript document-model scaffold - Usage: `--code-first`
...
### Options
**Name** - Human-readable name for a code-first document model - Usage: `--name, -n <str>`

**Id** - Document type ID for a code-first model, for example acme/invoice - Usage: `--id <str>`

**Extension** - File extension recorded by the code-first model - Usage: `--extension <str>`

**Version** - Version to scaffold; versions after v1 copy the previous authored tree - Usage: `--version, -v <number>`
...
### Flags
**Code First** - Create an authored TypeScript subgraph scaffold - Usage: `--code-first`
...
**Config File** - Powerhouse source config file - Usage: `--config-file <str>`

**Default:** `./powerhouse.config.json`
**Source** - Definition source as ./module.ts with an optional RFC 6901 export pointer - Usage: `--source <str>`
...
**Default:** ``
**Out Dir** - Directory containing the retained release report; requires --retained - Usage: `--out-dir <str>`




### Flags
**Json** - Write one versioned JSON report to stdout - Usage: `--json`

**Default:** `false`
**Warnings As Errors** - Make warnings invalidate the definition check - Usage: `--warnings-as-errors`

**Default:** `false`
**Release** - Use the release check profile; required with --retained - Usage: `--release`

**Default:** `false`
**Retained** - Validate the release report retained by the last ph build; requires --release - Usage: `--retained`
...
### Arguments
**Document Type Version *[required]*** - Document type and positive integer module version - Usage: `<documentType@version>`
...
**Default:** `false`
**Warnings As Errors** - Make warnings invalidate the definition inspection - Usage: `--warnings-as-errors`
...
### Arguments
**Family *[required]*** - Legacy family directory under document-models/ - Usage: `<family>`




### Flags
**To Code** - Render a verification-only code-first family beside legacy source - Usage: `--to-code`

**Default:** `false`
**Retire Legacy** - Create or consume a hash-bound legacy retirement plan - Usage: `--retire-legacy`

**Default:** `false`
**Apply** - Apply the selected write or approved retirement plan - Usage: `--apply`
...
### Options
**Plan** - Approved retirement-plan JSON path (required for retirement apply) - Usage: `--plan <str>`
...
### Arguments
**Name *[required]*** - Stable subgraph name - Usage: `<name>`
...
### Arguments
**Name *[required]*** - Legacy subgraph directory under subgraphs/ - Usage: `<name>`




### Flags
**To Code** - Render a verification-only code-first subgraph beside legacy source - Usage: `--to-code`

**Default:** `false`
**Apply** - Write the candidate instead of only reporting it - Usage: `--apply`
...
### Arguments
**Name *[required]*** - GraphQL scalar name - Usage: `<name>`
