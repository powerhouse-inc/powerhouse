...
In this tutorial, we'll show how to use a **GraphQL** query to query a document model. We'll continue with the **To-do List example** from our [introduction tutorial](/academy/Build/ManualTodoTutorial/CreateNewPowerhouseProject), but the process can be applied to any other document model.
