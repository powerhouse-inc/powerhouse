...
This guide covers advanced patterns for processors that need to mutate documents or query indexed data. It builds on the concepts from [Building a Processor](/academy/Build/WorkWithData/BuildingAProcessor) — read that first if you haven't already.

:::tip[Prerequisites]
Before reading this guide, make sure you're familiar with the basics:

- [Building a Processor](/academy/Build/WorkWithData/BuildingAProcessor) — processor interface, factories, and filters
...
- [Building a Processor](/academy/Build/WorkWithData/BuildingAProcessor) — processor basics
- [Relational Database Processor](/academy/Build/WorkWithData/RelationalDbProcessor) — database-backed processors
- [Processor Migration Guide](/academy/Reference/Processors/ProcessorMigrationGuide) — migrating from the legacy strand-based API
