...
<figure className="image-container">
  <img
    ...
    alt="The Products dashboard listing Vetra Studio instances"
  />
...
<figure className="image-container">
  <img
    ...
    alt="The New product dialog asking for an Anthropic API key"
  />
...
│  — or —          │▒│  — or —                             │
│  Active session  │▒│  A phase section or open document   │
│                  │▒│  — or —                             │
│                  │▒│  Build preview                      │
└──────────────────┴─┴─────────────────────────────────────┘
```
...
<figure className="image-container">
  <img
    ...
    alt="Vetra Studio home with the four phase-cycle cards"
  />
...
<figure className="image-container">
  <img
    ...
    alt="The Specify section showing a project with its document count"
  />
...
<figure className="image-container">
  <img
    ...
    alt="A document-model editor open in the main pane while the agent is paused"
  />
...
<figure className="image-container">
  <img
    ...
    alt="The BUILD pane showing a live preview of the generated app"
  />
