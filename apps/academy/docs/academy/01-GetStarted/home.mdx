...
<div className={styles.pathCard}>
  ...
  <div className={styles.cardContent}>
    ...
    <a
      ...
      className="path-button"
    >
      Build custom Drive-apps
    </a>
    <a
      href="/academy/MasteryTrack/BuilderEnvironment/CreateAPackageWithVetra"
      className="path-button"
    >
  ...
  >
    ...
    <div className={styles.cardContent}>
      <a
        ...
        className="path-button"
        style={{ padding: "0.75rem", margin: "0.25rem 0" }}
      >
...
<div className={styles.pathCard}>
  ...
  <div className={styles.cardContent}>
    ...
    <a
      href="/academy/MasteryTrack/WorkWithData/UsingSubgraphs"
      className="path-button"
    >
...
<div className={styles.pathCard}>
  ...
  <div className={styles.cardContent}>
    ...
    <a href="/academy/Cookbook#reactor-recipes" className="path-button">
      Reactor recipes
    </a>
  </div>
</div>
...
<div className={styles.pathCard}>
  ...
  <div className={styles.cardContent}>
    <a href="/academy/ExampleUsecases/Overview" className="path-button">
      Explore use-cases
    </a>
  </div>
</div>
