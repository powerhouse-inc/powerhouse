      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ lineHeight: '1.6' }}>
            ...
            Vetra helps you build any type of web application on a Reactive Document Architecture.<br />
            Define workflows once, deploy them globally, and co-own the software you create.<br />
