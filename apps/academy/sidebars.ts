  ...
  academySidebar: [
    {
      ...
      items: [
        'academy/GetStarted/InstallDemoPackage',
        'academy/GetStarted/LoginWithRenown',
        {
          type: 'category',
          label: 'To-Do List Tutorial',
          items: [{type: 'autogenerated', dirName: 'academy/01-GetStarted/03-ToDoList'}]
        },
      ],
    },
    {
