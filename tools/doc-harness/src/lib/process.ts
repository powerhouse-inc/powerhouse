// Copied verbatim from test/recipes-e2e/scripts/lib/runner.ts. Kept as a copy
// because that package is tsx-run with no exports map, and the process-group
// kill semantics below are exactly what a hung `claude -p` needs.
