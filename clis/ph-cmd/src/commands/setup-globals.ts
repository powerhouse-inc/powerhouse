 ...
 * valid directory name but not a valid npm package name (vite + npm reject
 * names starting with a dot). We let `ph init` create the project as `.ph`
 * and then rename it here to `ph-global`.
 */
function fixGlobalPackageName(): void {
