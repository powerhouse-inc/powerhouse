import { z } from 'zod'
import { Account, AddAccountInput, AddAuditReportInput, AddCommentInput, AddLineItemInput, AddVestingInput, AuditReport, AuditReportStatus, BudgetStatementState, BudgetStatus, Comment, CommentAuthor, CommentAuthorInput, DeleteAccountInput, DeleteAuditReportInput, DeleteCommentInput, DeleteLineItemInput, DeleteVestingInput, Ftes, FtesForecast, FtesForecastInput, LineItem, LineItemCategory, LineItemForecast, LineItemGroup, LineItemInput, LineItemsSortInput, Owner, SetFtesInput, SetMonthInput, SetOwnerInput, SetQuoteCurrencyInput, SortAccountsInput, SortLineItemsInput, UpdateAccountInput, UpdateCommentInput, UpdateLineItemInput, UpdateVestingInput, Vesting } from './'
...
export function BudgetStatementInputSchema() {
  return z.union([AddAccountInputSchema(), AddAuditReportInputSchema(), AddCommentInputSchema(), AddLineItemInputSchema(), AddVestingInputSchema(), DeleteAccountInputSchema(), DeleteAuditReportInputSchema(), DeleteCommentInputSchema(), DeleteLineItemInputSchema(), DeleteVestingInputSchema(), SetFtesInputSchema(), SetMonthInputSchema(), SetOwnerInputSchema(), SetQuoteCurrencyInputSchema(), SortAccountsInputSchema(), SortLineItemsInputSchema(), UpdateAccountInputSchema(), UpdateCommentInputSchema(), UpdateLineItemInputSchema(), UpdateVestingInputSchema()])
}
