...
> {
    ...
    public setInitialState(input: SetInitialStateInput, options?: ReducerOptions) {
        return this.dispatch(setInitialState(input), options);
    }

    public addStateExample(input: AddStateExampleInput, options?: ReducerOptions) {
        return this.dispatch(addStateExample(input), options);
    }

    public updateStateExample(input: UpdateStateExampleInput, options?: ReducerOptions) {
        return this.dispatch(updateStateExample(input), options);
    }

    public deleteStateExample(input: DeleteStateExampleInput, options?: ReducerOptions) {
        return this.dispatch(deleteStateExample(input), options);
    }

    public reorderStateExamples(input: ReorderStateExamplesInput, options?: ReducerOptions) {
